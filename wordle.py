...
while play_again != "n":
    ...
    for attempt in range(1, 7):
        ...
        if guess == word:
            print(Fore.CYAN + "You guessed the word in", attempt, Fore.CYAN +"tries!")
            break
            
        elif attempt == 6:
            print(Fore.RED + "You ran out of guesses! The word was", word, Fore.RED + ". Better luck next time...")
            
    play_again = input(Fore.YELLOW + "Enter 'n' to exit or enter any other key to play again. ")
    if play_again == "n":
